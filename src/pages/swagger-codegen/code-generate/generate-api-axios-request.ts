 ...
 * @Date: 2024-08-22 14:31:41
 * @Description: api-axios-request 声明生成方法
 */
...
export default function generateApiAxiosRequestDefineition(
  apiData: pathsItem & { requestParams: any },
  prefix: string = '',
) {
